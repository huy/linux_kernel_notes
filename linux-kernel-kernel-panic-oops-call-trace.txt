...
Unlike kernel panic, which can not be recovered and reboot the system, when the kernel detects a oops’s problem, it prints kernel state including call trace and kills any offending process.
